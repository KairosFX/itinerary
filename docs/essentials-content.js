window.__JAPAN_ESSENTIALS_CONTENT__ = {
  "bookingTransitItems": [
    ...
    },
    {
      ...
      "title": {
        "en": "Day 2 Kyoto East-access hotel",
        "ja": "2日目の京都東側アクセス向きホテル"
      },
      "summary": {
    ...
    },
    {
      ...
      "title": {
        "en": "Tokyo hotel nights",
        "ja": "東京ホテル泊"
      },
      "summary": {
        "en": "Tokyo hotel nights now sit on Days 5 and 6, so the base should support the Shibuya arrival, the fuller sightseeing day, and an easy Day 7 reset before the flight home.",
    ...
    },
    {
      ...
      "title": {
        "en": "Kyoto / Shin-Osaka -> Mishima shinkansen",
        "ja": "京都・新大阪 -> 三島 新幹線"
      },
      "summary": {
    ...
    },
    {
      ...
      "title": {
        "en": "Mt. Fuji area -> Tokyo / Shibuya",
        "ja": "富士エリア -> 東京・渋谷"
      },
      "summary": {
        "en": "Save the Tokyo handoff you expect to use on Day 5 so the Shibuya evening stays easy to land.",
  ...
  "transitDetailItems": [
    {
      ...
      "fallbackOptions": [
        ...
        {
          "en": "If the transfer window feels too tight, simplify the Day 4 arrival and protect the sunset part of the Fuji stay.",
          "ja": "接続が窮屈に感じる時は、4日目の到着後を簡潔にして、富士側の夕景時間を守ります。"
        }
      ],
      "action": {
        "href": "https://smart-ex.jp/en/index.php",
    ...
    },
    {
      ...
      "summary": {
        "en": "Treat the final Day 4 handoff as a practical station-to-lake move, not another sightseeing detour.",
        "ja": "4日目の最後は、観光の寄り道ではなく、駅から湖側へ入る実用的な移動として考えます。"
      },
      "segment": {
      ...
      "fallbackOptions": [
        ...
        {
          "en": "If weather looks weak, keep Day 4 to the lake base and hotel or onsen time instead of forcing every Fuji stop.",
          "ja": "天候が弱い時は、全立ち寄りを無理に詰めず、4日目を湖側の拠点とホテル・温泉時間中心にします。"
        }
      ],
      "action": {
        "href": "https://sekitori.jp/en/news/20250314_134/",
    ...
    },
    {
      ...
      "summary": {
        "en": "Keep Chureito / Shimoyoshida and Lake Kawaguchiko on the same Fuji-area day instead of splitting them across Day 4 and Day 5.",
        "ja": "忠霊塔・下吉田と河口湖は、4日目と5日目に分けず、同じ富士エリア日にまとめます。"
      },
      "segment": {
      ...
      "practicalNotes": [
        {
          "en": "Handle the Mishima-to-lake arrival first, then add one compact Fuji-area loop.",
          "ja": "まず三島から湖側への到着を済ませ、そのあと短めの富士エリア周遊を足します。"
        },
        {
        ...
        {
          "en": "Do not repeat Lake Kawaguchiko on Day 5; use Day 5 for the clean Tokyo handoff instead.",
          "ja": "5日目に河口湖を繰り返さず、5日目は東京へのきれいな受け渡しに使います。"
        }
      ],
      "prepReminders": [
        {
      ...
      "fallbackOptions": [
        {
          "en": "If visibility drops, trim Chureito and keep Lake Kawaguchiko as the one simple scenic stop.",
          "ja": "視界が落ちたら忠霊塔を削り、景色の立ち寄りは河口湖だけに絞ります。"
        },
        {
    ...
    },
    {
      ...
      "summary": {
        "en": "Use the Tokyo handoff as the second half of Day 5, landing in Shibuya for a focused evening rather than spreading arrival across the city.",
        "ja": "5日目後半は東京への受け渡しに充て、東京到着後は街を広げすぎず、渋谷の夜に集中します。"
      },
      "segment": {
      ...
      "transport": {
        "en": "Direct highway bus or rail depending on the timing that best fits your Shibuya evening. The direct bus anchor is around JPY 2,200 one way.",
      ...
      "practicalNotes": [
        {
          "en": "Decide whether you are going straight to your Tokyo base or dropping bags first before Shibuya.",
          "ja": "東京到着後に宿へ直行するか、荷物を置いてから渋谷へ向かうかを先に決めます。"
        },
        {
        ...
        {
          "en": "If the transfer starts running late, protect Shibuya food and Shibuya Sky before adding extra stops.",
          "ja": "移動が遅れ始めたら、余計な立ち寄りを増やす前に、渋谷の食事と渋谷スカイを守ります。"
        }
      ],
      "prepReminders": [
        {
      ...
      "fallbackOptions": [
        ...
        {
          "en": "If Tokyo arrival is running late, cut the first city stop and protect the rest of the evening.",
          "ja": "東京到着が遅れそうなら、最初の都内立ち寄りを一つ削って夜の流れを守ります。"
        }
      ],
      "action": {
        "href": "https://highway-buses.jp/course/shibuya.php",
