window.__JAPAN_BUDGET_CONTENT__ = {
  ...
  "sourceGroups": [
    ...
    },
    {
      ...
      "summary": {
        "en": "Day 3 now carries the full eastbound transfer into the Mt. Fuji base, and Day 4 then keeps Chureito Shimoyoshida, Lake Kawaguchiko, and the Tokyo handoff in one clean sequence. The live links now use Trip.com references for the key rail, bus, and local-transfer checks.",
        "ja": "3日目は富士エリア拠点までの東向き移動をまとめ、4日目は忠霊塔・下吉田、河口湖、東京への受け渡しを一つの流れに整理しました。ライブリンクも、主要な鉄道、バス、現地移動の確認先を Trip.com にそろえています。"
      },
      "links": [
        {
          "label": {
            "en": "Trip.com Shin-Osaka -> Mishima rail",
            "ja": "Trip.com 新大阪 -> 三島 鉄道"
          },
          "url": "https://my.trip.com/trains/japan/route/shin-osaka-to-mishima/"
        },
        {
          "label": {
            "en": "Trip.com Mishima -> Kawaguchiko bus",
            "ja": "Trip.com 三島 -> 河口湖 バス"
          },
          "url": "https://www.trip.com/things-to-do/experiences/fujikawaguchiko-bus-tickets/"
        },
        {
          "label": {
            "en": "Trip.com Fuji local transport",
            "ja": "Trip.com 富士現地移動"
          },
        ...
        {
          "label": {
            "en": "Trip.com Kawaguchiko -> Tokyo return",
            "ja": "Trip.com 河口湖 -> 東京 戻り"
          },
    ...
    },
    {
      ...
      "summary": {
        "en": "Shibuya Sky and Tokyo Skytree are the main timed tickets in the fixed route, while Kaiyukan remains a simpler Day 3 same-day ticket check. The current official Tokyo Skytree deck ticket now starts from JPY 1,800 online, while Kaiyukan's current official adult ticket remains JPY 2,700.",
        "ja": "固定ルートで主な時間指定チケットになるのは渋谷スカイと東京スカイツリーで、海遊館は3日目に当日判断しやすいチケットとして残しています。現在の東京スカイツリー公式天望デッキ券はオンラインで JPY 1,800 から、海遊館の公式大人料金は JPY 2,700 のままです。"
      },
      "links": [
        {
          "label": {
  ...
  "dayDefinitions": [
    ...
    },
    {
      ...
      "subtitle": {
        "en": "Arashiyama, Osaka waterfront reset, then the Fuji transfer night",
        "ja": "嵐山、大阪ベイエリア、そして富士への移動で締める日"
      },
      "items": [
        {
          "label": {
