window.__JAPAN_BUDGET_CONTENT__ = {
  ...
  "costIndex": {
    ...
    "kyoto-midrange-hotel": {
      ...
      "pricingTier": {
        "en": "Current Kyoto mid-range hotel",
        "ja": "現在の京都中価格帯ホテル"
      },
      "routeReason": {
    ...
    "kawaguchiko-base-hotel": {
      ...
      "assumption": {
        "en": "Day 3 now uses the current Booking.com SUPER HOTEL Fujikawaguchiko Natural Hot Spring listing because it still keeps the onsen reset, the Day 4 Fuji block, and the Tokyo handoff practical.",
        "ja": "3日目は、温泉で立て直しやすく、4日目の富士エリアのまとまりと東京への受け渡しも崩さない Booking.com の SUPER HOTEL Fujikawaguchiko Natural Hot Spring を基準にしています。"
      },
      "source": {
        "label": {
    ...
    "tokyo-base-hotel": {
      ...
      "assumption": {
        "en": "Tokyo now uses the current Booking.com The OneFive Tokyo Shibuya listing as the Shibuya base for Days 4, 5, and 6, while Day 7 still defaults to no paid stay because it is the flight-home day.",
        "ja": "東京は、4日目、5日目、6日目の渋谷拠点として Booking.com の The OneFive Tokyo Shibuya を基準にし、7日目は帰国日のため初期値では有料宿泊を入れていません。"
      },
      "source": {
        "label": {
  ...
  "sourceGroups": [
    {
      "id": "accommodation",
      "title": {
        "en": "Accommodation quotes",
        "ja": "宿泊見積り"
      },
      "summary": {
        "en": "The base stay plan is now explicit: private/local or no-cost Osaka night on Day 1 unless switched, Kyoto hotel on Day 2, one Mt. Fuji area stay on Day 3, Tokyo hotel nights on Days 4-6, and no paid stay by default on the Day 7 flight-home wrap-up.",
        "ja": "基本の滞在計画を明示しました。1日目の大阪は、切り替えない限りローカル・プライベート滞在または宿泊費なし、2日目は京都ホテル、3日目は富士エリア宿泊、東京ホテルは4日目から6日目で、7日目は帰国日のため初期値では有料宿泊を入れていません。"
      },
      "links": [
        {
          "label": {
