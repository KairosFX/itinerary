window.__JAPAN_BUDGET_CONTENT__ = {
  ...
  "costIndex": {
    "osaka-compact-hotel": {
      ...
      "assumption": {
        "en": "Used only if you switch a private/local or no-cost Osaka night to a paid hotel. Based on a current Expedia quote around JPY 6,189 before taxes for 2 adults at Hearton Hotel Shinsaibashi.",
        "ja": "大阪のローカル・プライベート滞在や宿泊費なしの夜を有料ホテルへ切り替える時だけ使います。ハートンホテル心斎橋の現在のExpedia見積り（2名税別約6,189円）を基準にしています。"
      },
      "source": {
        "label": {
    ...
    "kyoto-midrange-hotel": {
      ...
      "assumption": {
        "en": "Day 2 uses Hotel Resol Kyoto Shijo Muromachi at the current Expedia rate of JPY 13,152 before taxes for 2 adults.",
        "ja": "2日目は Hotel Resol Kyoto Shijo Muromachi の現在のExpedia料金（2名税別13,152円）を使っています。"
      },
      "source": {
        "label": {
    ...
    "kawaguchiko-base-hotel": {
      ...
      "roomCapacity": 2,
      "area": {
        "en": "Kawaguchiko station -> lake corridor",
        "ja": "河口湖駅から湖畔の動線"
      },
      "pricingTier": {
      ...
      "routeReason": {
        "en": "This area keeps the Day 4 Mishima handoff, Chureito / Shimoyoshida, and Lake Kawaguchiko practical without paying for a remote resort that fights the actual route.",
        "ja": "このエリアなら、4日目の三島ハンドオフ、忠霊塔・下吉田、河口湖をまとめやすく、実際の動線に合いにくい遠いリゾート立地へ余計に払わずに済みます。"
      },
      "assumption": {
        "en": "Day 4 uses HaoSTAY at JPY 15,709 before taxes for 2 adults, which fits the Mishima handoff and the one-night Fuji block before Tokyo.",
        "ja": "4日目は HAOSTAY の現在の料金（2名税別15,709円）を使っています。三島ハンドオフから東京前の1泊の富士エリア日に合うためです。"
      },
      "source": {
        "label": {
          "en": "HaoSTAY",
    ...
    "tokyo-base-hotel": {
      ...
      "assumption": {
        "en": "Tokyo uses Shibuya Hotel En at the current Expedia rate of JPY 19,820 before taxes for 2 adults. That same nightly quote is used for the fixed Tokyo nights on Days 5 and 6, while Day 7 defaults to no paid stay because it is the flight-home day.",
        "ja": "東京は Shibuya Hotel En の現在のExpedia料金（2名税別19,820円）を使っています。同じ1泊見積りを固定の東京泊である5日目と6日目に適用し、7日目は帰国日のため初期値では有料宿泊を入れていません。"
      },
      "source": {
        "label": {
          "en": "Shibuya Hotel En",
  ...
  "dayDefinitions": [
    ...
    },
    {
      ...
      "title": {
        "en": "Day 7 - Imperial Palace, Shinjuku + flight home",
        "ja": "7日目・皇居と新宿、そして帰国日"
      },
      "subtitle": {
        "en": "Imperial Palace, Shinjuku, and airport buffer",
        "ja": "皇居、新宿、空港の余白"
      },
      "items": [
        {
        ...
        {
          "label": {
            "en": "Bag storage or handoff if needed",
            "ja": "必要なら荷物預け・受け渡し"
          },
          "category": "baggage",
          "bucket": "optional",
