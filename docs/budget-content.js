window.__JAPAN_BUDGET_CONTENT__ = {
  ...
  "stayDefinitions": {
    ...
    "kawaguchiko-base-hotel": {
      ...
      "routeReason": {
        "en": "This base keeps the Day 4 Mishima handoff, the hot-spring reset, and the Lake Kawaguchiko side practical without paying for a remote resort location that fights the real station and bus flow.",
        "ja": "この拠点なら、4日目の三島ハンドオフ、温泉での立て直し、河口湖側の動きをまとめやすく、実際の駅・バス動線と離れた遠いリゾート立地へ余計に払わずに済みます。"
      },
      "cost": {
        "mode": "perGroup",
        "amount": 8700,
  ...
  "dayDefinitions": [
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "label": {
            "en": "Bag pickup / handoff if needed",
            "ja": "必要なら荷物預け・受け渡し"
          },
          "category": "baggage",
          "bucket": "optional",
