window.__JAPAN_BUDGET_CONTENT__ = {
  ...
  "costIndex": {
    ...
    "kawaguchiko-base-hotel": {
      ...
      "assumption": {
        "en": "Day 4 uses the saved HaoStay Kawaguchiko Ekimae stay because it fits the Mishima handoff and the one-night Fuji block before Tokyo.",
        "ja": "4日目は、三島ハンドオフから東京前の1泊の富士エリア日に合う HaoStay河口湖駅前 を保存して使っています。"
      },
      "source": {
        "label": {
          "en": "HaoStay Kawaguchiko Ekimae",
          "ja": "HaoStay河口湖駅前"
        },
