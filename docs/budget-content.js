window.__JAPAN_BUDGET_CONTENT__ = {
  ...
  "sourceGroups": [
    ...
    },
    {
      ...
      "summary": {
        "en": "Day 3 now carries the full eastbound transfer into the Mt. Fuji base, and Day 4 then keeps Chureito Shimoyoshida, Lake Kawaguchiko, and the Tokyo handoff in one clean sequence. The live transit links now prioritize Trip.com train and transport search pages where appropriate.",
        "ja": "3日目は富士エリア拠点までの東向き移動をまとめ、4日目は忠霊塔・下吉田、河口湖、東京への受け渡しを一つの流れに整理しました。移動リンクは、必要に応じて Trip.com の鉄道・交通検索ページを優先しています。"
      },
      "links": [
        {
          "label": {
    ...
    },
    {
      ...
      "summary": {
        "en": "Shibuya Sky and Tokyo Skytree are the main sunset-timed tickets in the fixed route, while Kaiyukan remains a simpler Day 1 opening-time ticket check. The current official Tokyo Skytree deck ticket now starts from JPY 1,800 online, while Kaiyukan's current official adult ticket remains JPY 2,700.",
        "ja": "固定ルートで主な時間指定チケットになるのは渋谷スカイと東京スカイツリーで、海遊館は1日目の開館時間に合わせて確認しやすいチケットとして残しています。現在の東京スカイツリー公式天望デッキ券はオンラインで JPY 1,800 から、海遊館の公式大人料金は JPY 2,700 のままです。"
      },
      "links": [
        {
          "label": {
  ...
  "dayDefinitions": [
    ...
    },
    {
      ...
      "subtitle": {
        "en": "Outer palace photo stop, Shinjuku/lunch, bags, and airport transfer",
        "ja": "皇居外苑の写真、新宿／昼食、空港の余白"
      },
      "items": [
        {
          "label": {
