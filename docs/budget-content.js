window.__JAPAN_BUDGET_CONTENT__ = {
  ...
  "assumptionCopy": {
    ...
    "ja": "費用モデルは、大阪 -> 京都 -> 富士エリア -> 東京の固定7日間ルートに合わせ、ホテル金額は実際の日程を決めるまで基準見積りとして扱います。"
  },
  "costIndex": {
    "osaka-compact-hotel": {
      "amount": 9542,
      ...
      "routeReason": {
        "en": "Use this when you need a paid Osaka night. Yotsubashi / Nishi-Shinsaibashi still supports the actual Day 1 Minami walking and the Day 2 Kaiyukan start better than a random Osaka district.",
        "ja": "大阪で有料宿が必要な時はこの立地を使います。四ツ橋・西心斎橋寄りなら、1日目のミナミ散策と2日目の海遊館スタートに合いやすく、無関係な地区のホテルより実用的です。"
      },
      "assumption": {
    ...
    "kawaguchiko-base-hotel": {
      ...
      "routeReason": {
        "en": "This area keeps the Day 3 Mishima handoff plus the Day 4 Chureito Shimoyoshida and Lake Kawaguchiko block practical without paying for a remote resort that fights the actual route.",
  ...
  "sourceGroups": [
    ...
    },
    {
      ...
      "summary": {
        "en": "Day 3 now carries the full eastbound transfer into the Mt. Fuji base, and Day 4 then keeps Chureito Shimoyoshida, Lake Kawaguchiko, and the Tokyo handoff in one clean sequence. The live links now prioritize official SmartEX, official highway-bus pages, and working official bus search results where possible.",
        "ja": "3日目は富士エリア拠点までの東向き移動をまとめ、4日目は忠霊塔・下吉田、河口湖、東京への受け渡しを一つの流れに整理しました。ライブリンクも、可能な限り SmartEX 公式、高速バス公式、動作する公式バス検索結果を優先しています。"
      },
      "links": [
        {
          "label": {
            "en": "SmartEX Shinkansen booking",
            "ja": "SmartEX 新幹線予約"
          },
          "url": "https://smart-ex.jp/en/lp/app/"
        },
        {
          "label": {
        ...
        },
        {
          ...
          "url": "https://sekitori.jp/en/apps/results/?%5BnextDateFlag=true%5D&getOffAreaMiddleGroupId=2&getOffAreaType=1&nextDateFlag=true&rideAreaType=2&rideBusStopId=8&rideDate=today"
        },
        {
          "label": {
            "en": "Tokyu Bus Shibuya -> Kawaguchiko",
            "ja": "Tokyu Bus 渋谷 -> 河口湖"
          },
          "url": "https://www.tokyubus.co.jp/tourist/highway/"
        },
        {
          "label": {
            "en": "Fujikyu Railway fare",
            "ja": "富士急行線運賃"
          },
    ...
    },
    {
      ...
      "summary": {
        "en": "Shibuya Sky and Tokyo Skytree are the main timed tickets in the fixed route, while Kaiyukan remains a simpler Day 2 same-day ticket check. The current official Tokyo Skytree deck ticket now starts from JPY 1,800 online, while Kaiyukan's current official adult ticket remains JPY 2,700.",
        "ja": "固定ルートで主な時間指定チケットになるのは渋谷スカイと東京スカイツリーで、海遊館は2日目に当日判断しやすいチケットとして残しています。現在の東京スカイツリー公式天望デッキ券はオンラインで JPY 1,800 から、海遊館の公式大人料金は JPY 2,700 のままです。"
      },
      "links": [
        {
          "label": {
  ...
  "stayDefinitions": {
    "osaka-compact-hotel": {
      ...
      "routeReason": {
        "en": "Use this when you need a paid Osaka night. Yotsubashi / Nishi-Shinsaibashi keeps Day 1 Minami walking and the Day 2 Kaiyukan start practical while cutting the fallback room cost.",
        "ja": "大阪で有料宿が必要な時はこの立地を使います。四ツ橋・西心斎橋寄りなら、1日目のミナミ散策と2日目の海遊館スタートをまとめやすく、代替宿の費用も抑えやすくなります。"
      },
      "cost": {
        "mode": "perGroup",
        "amount": 9542,
    ...
    "kawaguchiko-base-hotel": {
      ...
      "routeReason": {
        ...
        "ja": "この拠点なら、3日目の三島ハンドオフ、温泉での立て直し、4日目の忠霊塔・下吉田と河口湖のまとまりをまとめやすく、実際の駅・バス動線と離れた遠いリゾート立地へ余計に払わずに済みます。"
      },
      "cost": {
        "mode": "perGroup",
        "amount": 9800,
    ...
    "tokyo-base-hotel": {
      ...
      "routeReason": {
        ...
        "ja": "渋谷は4日目の到着後の主役であり、この渋谷中心部の拠点のままなら、その後の東京日程も地区を変えずに進めやすくなります。"
      },
      "cost": {
        "mode": "perGroup",
        "amount": 9800,
  ...
  "dayDefinitions": [
    {
      ...
      "subtitle": {
        "en": "Arrival, Minami, and first-night walk",
        "ja": "到着後のミナミと初夜の街歩き"
      },
      "items": [
        {
          "label": {
            "en": "Osaka city hop into Minami",
            "ja": "ミナミへ入る大阪市内移動"
          },
    ...
    },
    {
      ...
      "title": {
        "en": "Day 2 - Osaka + Kyoto",
        "ja": "2日目・大阪と京都"
      },
      "subtitle": {
        "en": "Kaiyukan, Kyoto hotel check-in, then the east-side temple cluster",
        "ja": "海遊館、京都ホテルのチェックイン、東山エリアへ進む日"
      },
      "items": [
        {
          "label": {
    ...
    },
    {
      ...
      "subtitle": {
        "en": "Fuji-area stops first, then the Shibuya handoff",
        "ja": "富士エリアの立ち寄りを先に回し、そのあと渋谷へ入る日"
      },
      "items": [
        {
          "label": {
    ...
    },
    {
      ...
      "subtitle": {
        "en": "Shibuya walk and skyline night",
        "ja": "渋谷散策と夜景のまとまり"
      },
      "items": [
        {
          "label": {
            "en": "Shibuya local hop",
            "ja": "渋谷周辺の移動"
          },
          "category": "localTransit",
          "bucket": "required",
    ...
    },
    {
      ...
      "subtitle": {
        "en": "Skytree, Solamachi, and Akihabara",
        "ja": "スカイツリー、ソラマチ、秋葉原"
      },
      "items": [
        {
    ...
    },
    {
      ...
      "subtitle": {
        "en": "Imperial Palace, Shinjuku, bags, and airport transfer",
        "ja": "皇居、新宿、空港の余白"
      },
      "items": [
        {
