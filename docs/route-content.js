window.__JAPAN_ROUTE_CONTENT__ = (() => {
  const tripNotes = [
    ...
    },
    {
      ...
      note: {
        en: "Keep Chureito Shimoyoshida early for the best Fuji odds, with time for the 398 stairs, photos, and a rest. Then move through Lake Kawaguchiko, Oishi Park, and the Mt. Fuji Panoramic Ropeway with weather, energy, crowds, and time in mind.",
        ja: "富士山が見えやすい朝に忠霊塔・下吉田を置き、398段の階段、写真、休憩時間を入れる。その後は天気、体力、混雑、時間を見ながら河口湖、大石公園、富士山パノラマロープウェイへ回す。"
      },
      summary: {
